...
[Balance RPC](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L19) provides a pulsed stream of user balance updates.
...
## [Example Response](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L152)
