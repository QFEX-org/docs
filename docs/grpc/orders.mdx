...
description: "Bidirectional streaming for sending orders and receiving order responses via [StreamOrders RPC](https://github.com/QFEX-org/proto/blob/main/port.proto#L9)"
---
