...
[StreamOrders RPC](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L9) provides a bidirectional streaming interface for sending Add, Modify, and Cancel order requests and receiving responses.

## Example Requests

### [Add Order](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L27)
...
### [Cancel Order](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L38)
...
<Note>
  ...
  _all_ orders for your account that share the same client_order_id. Uniqueness
...
### [Modify Order](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L46)
...
## [Example Response](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L84)
