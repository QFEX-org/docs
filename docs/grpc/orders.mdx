---
title: "Order Entry"
description: "[StreamOrders RPC](https://github.com/QFEX-org/proto/blob/main/port.proto#L9) provides a bidirectional streaming interface for sending Add, Modify, and Cancel order requests and receiving responses."
---
