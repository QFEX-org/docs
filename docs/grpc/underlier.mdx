...
[Underlier RPC](https://github.com/QFEX-org/proto/blob/main/market_data.proto#L12) provides a pulsed underlier price stream, aggregated over multiple exchanges. It is used in the funding calculation. 
