...
[Reference Data RPC](https://github.com/QFEX-org/proto/blob/main/proto/market_data.proto#L15) returns a list of all available symbols and their reference data.
...
## [Example Response](https://github.com/QFEX-org/proto/blob/main/proto/market_data.proto#L85)
