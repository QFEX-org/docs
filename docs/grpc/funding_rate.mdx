---
title: "Streaming Funding Rate"
description: "Consume live funding rate"
---

<Note>
  This example shows how to call the
  [`GetFundingRate`](https://github.com/QFEX-org/proto/blob/main/market_data.proto#L13)
  RPC to stream real‑time funding rate updates.
</Note>

## Example: Streaming Funding Rate
