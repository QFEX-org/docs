...
[Positions RPC](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L18) provides a pulsed stream of user positions and symbol-wise trading statistics.
...
## [Example Response](https://github.com/QFEX-org/proto/blob/main/proto/port.proto#L146)
