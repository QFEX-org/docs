...
[Trades RPC](https://github.com/QFEX-org/proto/blob/main/proto/market_data.proto#L11) provides a realtime stream of trades by all users of QFEX.
...
## [Example Response](https://github.com/QFEX-org/proto/blob/main/proto/market_data.proto#L43)
