...
description: "Consuming public trade feed. This includes trades by all users of QFEX."
---

<Note>
  This example shows how to call the [GetTrades](https://github.com/QFEX-org/proto/blob/main/market_data.proto#L11) RPC to stream live trade data
  from the QFEX-org/proto definitions.
</Note>

## Example: Streaming Trades
