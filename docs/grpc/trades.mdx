...
description: "Consuming public trade feed via [Trades RPC](https://github.com/QFEX-org/proto/blob/main/market_data.proto#L11). This includes trades by all users of QFEX."
---
