...
description: "[Order Book RPC](https://github.com/QFEX-org/proto/blob/main/market_data.proto#L10) provides a 50ms pulsed stream of the order book up to 20 levels."
---
...
## [Example Response](https://github.com/QFEX-org/proto/blob/main/market_data.proto#L35)
