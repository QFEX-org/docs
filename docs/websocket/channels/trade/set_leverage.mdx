...
ws.on("open", () => {
  ...
  ws.send(
    JSON.stringify({
      type: "set_user_leverage",
      params: { symbol: "AAPL-USD", leverage: 20.0 },
    })
  );
});
...
func main() {
	...
	mustWriteJSON(c, map[string]any{
		"type": "set_user_leverage",
		"params": map[string]any{"symbol": "AAPL-USD", "leverage": 20.0},
	})
}
```
  ...
  public static void main(String[] args) {
    ...
    WebSocketListener li = new WebSocketListener() {
      @Override public void onOpen(WebSocket ws, Response r) {
        ...
        ws.send("{\"type\":\"set_user_leverage\",\"params\":{\"symbol\":\"AAPL-USD\",\"leverage\":20.0}}");
      }
