---
title: "Order Entry — Cancel All Orders"
---
...
const ws = new WebSocket("wss://trade.psex.io");
...
func main() {
	c, _, err := websocket.DefaultDialer.Dial("wss://trade.psex.io", nil)
...
<Note>
  This cancels **all open orders across all symbols** for the authenticated account.  
  If you only want to cancel specific orders, use the [Cancel Order](/docs/order-entry/cancel-order) endpoint instead.
</Note>
