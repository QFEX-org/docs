...
Send this immediately after connecting to `wss://trade.psex.io`:
...
ws.on("open", () => {
  ...
  ws.send(JSON.stringify({ type: "subscribe", params: { channels: ["balances"] } }));
});
...
public class BalancesSub {
  public static void main(String[] args) {
    ...
    Request req = new Request.Builder().url("wss://trade.psex.io").build();
